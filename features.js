...
function getFeatures(tokenData, features=[], featuresReduced=[]) {
  ...
  let SCALE, COLOR_SCHEME, DARK_C, LIGHTENED_DARK_C, LIGHT_C, LIGHT_GRADIENT_C, BRIGHT_LIGHT_C, BRIGHT_DARK_C, ACCENT_C, LIGHTENED_ACCENT_C, STIPLE_C, LIGHT_ACCENT_C, HUE, DENOMINATION, ROSETTE_STYLE, MAIN_CENTER_PIECE, IS_CRYPTO, IS_VINTAGE, IS_DECO, IS_BULLION, IS_MAIN, ROSETTE_FILL_C, ROSETTE_STROKE_C, HIGHLIGHT, SHOW_NUMERALS, BG_TYPE, BG_PATTERN, SHOW_BORDER, SHOW_CORNERS, CORNER_COMPONENT_LOCATIONS, STAR_NOTE, EMBLEM1, EMBLEM_NUMBER1, EMBLEM_HOLO1, EMBLEM2, EMBLEM_NUMBER2, EMBLEM_HOLO2, NO_NATURAL_DENOMINATION, VIBRANT_GRADIENT, MISPRINT_ROSETTE_PARAMS_EXCEEDED, MISPRINT_LATHE_MALFUNCTION, MISPRINT_HETERO_ROSETTES, MISPRINT_OFF_CENTER, MISPRINT_LOW_INK, MISPRINT_PRINTING_OBSTRUCTED, MISPRINT_REVERSED, MISPRINT_ROSETTE_FLURRY, MISPRINT_MISSING_CENTER, MISPRINT_PIGMINTATION_MALFUNCTION1, MISPRINT_PIGMINTATION_MALFUNCTION2, MISPRINT_PIGMINTATION_MISSING, MISPRINT_SKEWED, MISPRINT_HEAVY_INK, IS_MISPRINT, IS_PIGMINT_MISPRINT, FORCE_SHOW_ROSETTE, COOL_SERIAL_NUM, COUNTERFEIT, IS_SILVER, LAYOUT
  let STROKE_MOD = 1
  const W = 700
  const H = 400
  const W_H_RATIO = W/H
  ...
  MISPRINT_PIGMINTATION_MISSING = prb(0.02)
  ...
  else  features.push('Layout: Ticket')
